// Provider dello stato di progetto (audio, annotazioni, struttura, strati,
// notazione, relazioni, persistenza). Il contesto e il hook `useProject` vivono in
// useProject.ts, separati da questo componente perché Fast Refresh funziona solo
// sui file che esportano soltanto componenti (react-refresh/only-export-components).
import { useCallback, useEffect, useMemo, useRef, useState } from 'react'
import type { ReactNode } from 'react'
import { ProjectContext, type ProjectContextValue } from './useProject'
